          ...
          children: [
            Positioned.fill(
              child: _isInitialized
                  ? (_isPKMode ? _buildPKVideoLayout() : _buildVideoLayout())
                  : Container(
                      decoration: const BoxDecoration(
                        gradient: LinearGradient(
                          begin: Alignment.topLeft,
            ...
            if (_isInitialized)
              _isPKMode ? _buildPKModeOverlay() : _buildStandardModeOverlay()
            else
